...
ax.legend([line_pdp_neural, line_gps_neural, line_gt],
          ['Neural policy learned by PDP', 'Neural policy learned by GPS', 'Trajectory solved by OC solver'],
          facecolor='white', framealpha=0.5, loc='best', ncol=1)
...
# env.play_animation(pole_len=1, dt=dt, state_traj=pdp_neural_sol['state_traj'], save_option=0, title='PDP-NN')
# env.play_animation(pole_len=1, dt=dt, state_traj=gps_neural_sol['state_traj'], save_option=0, title='GPS-NN')